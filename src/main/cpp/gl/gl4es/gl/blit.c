...
void gl4es_blitTexture_gles1(GLuint texture,
    ...
    if (old_cli!=0) gl4es_gles_glClientActiveTexture(GL_TEXTURE0);
    ...
    if (old_cli!=0) gl4es_gles_glClientActiveTexture(GL_TEXTURE0+old_cli);
    ...
    if(!glstate->blit) {
      ...
      gl4es_gles_glGetShaderiv( glstate->blit->pixelshader, GL_COMPILE_STATUS, &success );
        if (!success)
        {
            ...
            char log[400];
          gl4es_gles_glGetShaderInfoLog(glstate->blit->pixelshader_alpha, 399, NULL, log);
            SHUT_LOGE("MobileGlues-gl4es: Failed to produce blit fragment shader.\n%s", log);
            free(glstate->blit);
            glstate->blit = NULL;
        }
      ...
      gl4es_gles_glGetShaderiv( glstate->blit->pixelshader_alpha, GL_COMPILE_STATUS, &success );
        if (!success)
        {
            ...
            char log[400];
          gl4es_gles_glGetShaderInfoLog(glstate->blit->pixelshader_alpha, 399, NULL, log);
            SHUT_LOGE("MobileGlues-gl4es: Failed to produce blit with alpha fragment shader.\n%s", log);
            free(glstate->blit);
            glstate->blit = NULL;
        }
      ...
      gl4es_gles_glGetShaderiv( glstate->blit->vertexshader, GL_COMPILE_STATUS, &success );
        if( !success )
        {
            ...
            char log[400];
          gl4es_gles_glGetShaderInfoLog(glstate->blit->pixelshader_alpha, 399, NULL, log);
            SHUT_LOGE("MobileGlues-gl4es: Failed to produce blit vertex shader.\n%s", log);
            free(glstate->blit);
            glstate->blit = NULL;
        }
      ...
      gl4es_gles_glGetShaderiv( glstate->blit->vertexshader_alpha, GL_COMPILE_STATUS, &success );
        if( !success )
        {
            ...
            char log[400];
          gl4es_gles_glGetShaderInfoLog(glstate->blit->pixelshader_alpha, 399, NULL, log);
            SHUT_LOGE("MobileGlues-gl4es: Failed to produce blit with alpha vertex shader.\n%s", log);
            free(glstate->blit);
            glstate->blit = NULL;
        }
      ...
      gl4es_gles_glGetProgramiv( glstate->blit->program, GL_LINK_STATUS, &success );
        if( !success )
        {
            SHUT_LOGE("MobileGlues-gl4es: Failed to link blit program.\n");
            free(glstate->blit);
            glstate->blit = NULL;
        }
