...
void APIENTRY_GL4ES gl4es_glBlendColor(GLclampf red, GLclampf green, GLclampf blue, GLclampf alpha) {
    ...
    if(!globals4es.shaderblend) {
        ...
        if  (gl4es_gles_glBlendColor)
            {} //STUB of gl4es_gles_glBlendColor(red, green, blue, alpha);
        else {
            static int test = 1;
            if (test) {
                LOGD("MobileGlues-gl4es: stub glBlendColor(%f, %f, %f, %f)\n", red, green, blue, alpha);
                test = 0;
            }
        }
    }
...
void APIENTRY_GL4ES gl4es_glBlendFuncSeparate(GLenum sfactorRGB, GLenum dfactorRGB, GLenum sfactorAlpha, GLenum dfactorAlpha)
{
    ...
    #ifndef PANDORA
        if(gl4es_gles_glBlendFuncSeparate==NULL) {
    ...
    #endif
        {} //STUB of gl4es_gles_glBlendFuncSeparate(sfactorRGB, dfactorRGB, sfactorAlpha, dfactorAlpha);
    }
...
void APIENTRY_GL4ES gl4es_glBlendEquationSeparate(GLenum modeRGB, GLenum modeA) {
    ...
    if(globals4es.shaderblend) {
        ...
        #ifndef PANDORA
        if(gl4es_gles_glBlendEquationSeparate)
        #endif
        {} //STUB of gl4es_gles_glBlendEquationSeparate(modeRGB, modeA);
    }
...
void APIENTRY_GL4ES gl4es_glBlendFunc(GLenum sfactor, GLenum dfactor) {
    ...
    if(globals4es.shaderblend) {
        ...
        switch(sfactor) {
            #if 0
            case GL_SRC_COLOR:
                if (gl4es_gles_glBlendFuncSeparate) {
                    {} //STUB of gl4es_gles_glBlendFuncSeparate(sfactor, dfactor, sfactor, dfactor);
                    return;
                }
    ...
    #ifdef ODROID
        if(gl4es_gles_glBlendFunc)
    #endif
        {} //STUB of gl4es_gles_glBlendFunc(sfactor, dfactor);
    }
}
...
void APIENTRY_GL4ES gl4es_glBlendEquation(GLenum mode) {
    ...
    if(globals4es.shaderblend) {
        ...
        errorGL();
        #ifdef ODROID
        if(gl4es_gles_glBlendEquation)
        #endif
        {} //STUB of gl4es_gles_glBlendEquation(mode);
    }
}
