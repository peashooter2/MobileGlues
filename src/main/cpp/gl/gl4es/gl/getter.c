...
GLenum APIENTRY_GL4ES gl4es_glGetError(void) {
    DBG(SHUT_LOGD("MobileGlues-gl4es: glGetError(), noerror=%d, type_error=%d shim_error=%s\n", globals4es.noerror, glstate->type_error, PrintEnum(glstate->shim_error));)
    ...
    if(glstate->type_error==1)
        gl4es_gles_glGetError();  // purge error log
...
void APIENTRY_GL4ES gl4es_glGetPointerv(GLenum pname, GLvoid* *params) {
    DBG(SHUT_LOGD("MobileGlues-gl4es: glGetPointerv(%s, %p)\n", PrintEnum(pname), params);)
    noerrorShim();
    switch(pname) {
...
const GLubyte* APIENTRY_GL4ES gl4es_glGetString(GLenum name) {
    DBG(SHUT_LOGD("MobileGlues-gl4es: glGetString(%s)\n", PrintEnum(name));)
    ...
    switch (name) {
        ...
        default:
            if(name&0x10000) {
                ...
                return gl4es_gles_glGetString(name-0x10000);
            }
			errorShim(GL_INVALID_ENUM);
            return (GLubyte*)"";
    }
...
void APIENTRY_GL4ES gl4es_glGetIntegerv(GLenum pname, GLint *params) {
    DBG(SHUT_LOGD("MobileGlues-gl4es: glGetIntegerv(%s, %p)\n", PrintEnum(pname), params);)
    if (params==NULL) {
    ...
    switch (pname) {
        ...
        case GL_ALIASED_POINT_SIZE_RANGE:
            gl4es_gles_glGetIntegerv(GL_ALIASED_POINT_SIZE_RANGE, params);
            break;
        case GL_NUM_COMPRESSED_TEXTURE_FORMATS:
            gl4es_gles_glGetIntegerv(GL_NUM_COMPRESSED_TEXTURE_FORMATS, params);
            (*params)+=4;	// adding fake DXTc
            break;
        case GL_COMPRESSED_TEXTURE_FORMATS:
            gl4es_gles_glGetIntegerv(GL_NUM_COMPRESSED_TEXTURE_FORMATS, &dummy);
            // get standard ones
            gl4es_gles_glGetIntegerv(GL_COMPRESSED_TEXTURE_FORMATS, params);
            // add fake DXTc
...
void APIENTRY_GL4ES gl4es_glGetFloatv(GLenum pname, GLfloat *params) {
    DBG(SHUT_LOGD("MobileGlues-gl4es: glGetFloatv(%s, %p)\n", PrintEnum(pname), params);)
    ...
    switch (pname) {
        case GL_POINT_SIZE_RANGE:
        case GL_ALIASED_POINT_SIZE_RANGE:
            gl4es_gles_glGetFloatv(GL_ALIASED_POINT_SIZE_RANGE, params);
            break;
...
void APIENTRY_GL4ES gl4es_glGetDoublev(GLenum pname, GLdouble *params) {
    DBG(SHUT_LOGD("MobileGlues-gl4es: glGetDoublev(%s, %p)\n", PrintEnum(pname), params);)
    GLfloat tmp[4*4];
    LOAD_GLES(glGetFloatv);
    noerrorShim();
    ...
    switch (pname) {
        case GL_POINT_SIZE_RANGE:
        case GL_ALIASED_POINT_SIZE_RANGE:
            gl4es_gles_glGetFloatv(GL_ALIASED_POINT_SIZE_RANGE, tmp);
        ...
        default:
            errorGL();
            gl4es_gles_glGetFloatv(pname, tmp);
            params[0] = tmp[0];
    }
}
...
void APIENTRY_GL4ES gl4es_glGetLightfv(GLenum light, GLenum pname, GLfloat * params) {
    DBG(SHUT_LOGD("MobileGlues-gl4es: glGetLightfv(%s, %s, %p)\n", PrintEnum(light), PrintEnum(pname), params);)
...
void APIENTRY_GL4ES gl4es_glGetMaterialfv(GLenum face, GLenum pname, GLfloat * params) {
    DBG(SHUT_LOGD("MobileGlues-gl4es: glGetMaterialfv(%sn %s, %p)\n", PrintEnum(face), PrintEnum(pname), params);)
...
const GLubyte* APIENTRY_GL4ES gl4es_glGetStringi(GLenum name, GLuint index) {
    DBG(SHUT_LOGD("MobileGlues-gl4es: glGetStringi(%s, %d)\n", PrintEnum(name), index);)
    BuildExtensionsList();
...
{
    DBG(SHUT_LOGD("MobileGlues-gl4es: unsupported glGetMinmaxParameteriv(%s, %s, %p)\n", PrintEnum(target), PrintEnum(pname), params);)
    errorShim(GL_INVALID_VALUE);
}
...
{
    DBG(SHUT_LOGD("MobileGlues-gl4es: unsupported glGetMinmaxParameterfv(%s, %s, %p)\n", PrintEnum(target), PrintEnum(pname), params);)
    errorShim(GL_INVALID_VALUE);
}
